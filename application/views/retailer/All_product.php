...
<div class="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row heading-bg">
            ...
            <h5 class="txt-dark" style="text-transform: uppercase;"><span class="bg-dark" style="color: white; padding: 5px;">products from all pharmacies</span></h5>
                        ...
                        <div class="panel-body pa-0">
                            <article class="col-item">
                                ...
                                <div class="info">
                                    ...
                                    <!--get location of each pharmacy .start-->
                                    <?php
                                    $this->db->where('user', $seller_id); 
                                    $pharmacy_data=$this->db->get('pharmacy');
                                    foreach($pharmacy_data->result() as $pharmacy_row){
                                        $pharmacyid=$pharmacy_row->id;
                                        $pharmacyName=$pharmacy_row->name;
                                        ...
                                        foreach($pharmacy_location->result() as $loc_row){
                                    ?>
                                    <a href="" class="head-font block text-default long_text" style="font-size: 14px; color: black;">from, <?=$pharmacyName?></a>
                                    
                                    <span class="head-font block text-default long_text text-muted" style="font-size: 12px;"><?=$loc_row->location_name;?></span>
                                    
                                    <?php
                                        }
                                    }
                                    ?>
                                    <!--get location of each pharmacy .end -->
