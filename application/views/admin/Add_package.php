                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="form-wrap">
                                ...
                                <form method="post" action="<?=base_url('a_main/save_package');?>" enctype="multipart/form-data" method="post" data-toggle="validator" accept-charset="utf-8" onsubmit="return checkCoords();">
                                    ...
                                    <div class="alert <?php if($this->session->userdata('feedback')=='exists'){echo 'alert-danger';}else if($this->session->userdata('feedback')=='saved'){echo 'alert-success';}?> alert-dismissable product_notify_div">
                                        ...
                                        <p class="pull-left">
                                            ...
                                            if($this->session->userdata('feedback') == 'exists'){
                                                echo 'this selling package already exists.';
                                            }else if($this->session->userdata('feedback') == 'saved'){
                                                echo 'selling package was saved successfully';
                                            }
                                            ?>
                                        </p> 
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group suggestion_area">
                                                <label for="productname" class="control-label mb-10">Selling package <abbr style="color: red;" title="required">*</abbr></label>
                                                <input type="text" class="form-control" placeholder="Enter selling package name" name="selling_package" data-error="Please fill out this field." required>
